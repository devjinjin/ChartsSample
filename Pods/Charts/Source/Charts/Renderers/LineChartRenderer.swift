                ...
                for j in _xBounds
                {
                    ...
                    if dataSet.isDrawValuesEnabled {
                        ...
                        ChartUtils.drawText(
                            ...
                            align: .center,
                            attributes: [NSAttributedString.Key.font: valueFont, NSAttributedString.Key.foregroundColor: dataSet.valueTextColorAt(j), NSAttributedString.Key.backgroundColor : UIColor.red])
